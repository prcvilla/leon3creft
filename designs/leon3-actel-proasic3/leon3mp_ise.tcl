...
project set family "PROASIC3E"
project set device A3PE1500
project set speed Std
project set package PQFP
...
lib_vhdl new gsi
lib_vhdl new work
xfile add "../../boards/a3pe-proto-kit/leon3mp.ucf"
...
project set "Macro Search Path" "../../netlists/xilinx/PROASIC3E" -process "Translate"
